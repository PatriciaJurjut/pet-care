...
FOOD_SERVO_ANGLE_CLOSED = 88 
FOOD_SERVO_ANGLE_OPEN = 60
FOOD_COMPLETE_REFILL_TIME = 1.5 # seconds until bowl is refilled with one portion of food
FOOD_QUICK_TREAT_TIME = 0.5 # seconds until bowl has enough food for a treat
FOOD_STANDARD_CYCLES_NUMBER = 2
