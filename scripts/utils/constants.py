...
WATER_SENSOR_ANALOG_PIN_INPUT = 0x40  # water sensor - channel 0
WATER_SERVO_PIN = 7
...
WATER_REFILL_STOP_TIME = timedelta(seconds=10)  # stop condition, for when refill cannot be made => container empty
...
FOOD_COMPLETE_REFILL_TIME = 0.5  # seconds until bowl is refilled with one portion of food
FOOD_QUICK_TREAT_TIME = 0.3  # seconds until bowl has enough food for a treat
